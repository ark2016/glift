...
glift.displays.statusbar.StatusBar.prototype.gameInfo = function (
  gameInfoArr,
  captureCount
) {
  ...
  infoWindow.textDiv
    .append(
      glift.dom
        ...
        .css(
          glift.util.obj.flatMerge(gameInfoTheme.textTitle, gameInfoTheme.text)
        )
    )
    .append(
      glift.dom.convertText(
        textArray.join('\n'),
        false /* useMarkdown */,
