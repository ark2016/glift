(function () {
  ...
  test('ptToBoardPt', function () {
    var board = defaultCreate();
    deepEqual(board.ptToBoardPt(pt(0, 0)).toString(), pt(7, 0).toString());
    deepEqual(board.boardPtToPt(pt(7, 0)).toString(), pt(0, 0).toString());
    deepEqual(
  ...
  test('diff', function () {
    ...
    ok(
      diff[0].newValue.equals(diffBoard.getIntBoardPt(16, 2)),
      'Should be equal'
    );
  });
  ...
  test('diff: Marks', function () {
    ...
    ok(
      diff[0].prevValue.equals(board.getIntBoardPt(14, 1)),
      'Prev values: Should be equal'
    );
    ok(
      diff[0].newValue.equals(diffBoard.getIntBoardPt(14, 1)),
