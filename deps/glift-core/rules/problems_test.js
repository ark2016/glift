(function () {
  ...
  test('IsCorrectPosition: trivial correctness', function () {
    ...
    deepEqual(
      glift.rules.problems.positionCorrectness(movt, { GB: [] }),
  ...
  test('GoGameGuru Problem', function () {
    ...
    deepEqual(
      glift.rules.problems.positionCorrectness(movt, {
        GB: [],
  ...
  test('Multi-solution-problem', function () {
    ...
    movt.moveDown(0);
    deepEqual(
      glift.rules.problems.positionCorrectness(movt, { C: ['Correct'] }),
      problemResults.CORRECT,
      'Should be correct'
    );
    movt.moveUp().moveDown(1);
